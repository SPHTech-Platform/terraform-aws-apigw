...
| <a name="input_cache_cluster_size"></a> [cache\_cluster\_size](#input\_cache\_cluster\_size) | The size of the cache cluster for the stage, if enabled | `string` | `""` | no |
...
| <a name="input_enable_cloud_watch_log"></a> [enable\_cloud\_watch\_log](#input\_enable\_cloud\_watch\_log) | Specifies whether a cloud watch log enabled. | `bool` | `false` | no |
| <a name="input_key_names"></a> [key\_names](#input\_key\_names) | Key names | `map` | `{}` | no |
...
| <a name="input_stage_variables"></a> [stage\_variables](#input\_stage\_variables) | Stage variables for the API gateway stage | `map` | `{}` | no |
